...
export default function Cart({ cartItems ,setCartItems }) {
 ...
 setCartItems(updatedItems);
    ...
    function placeOrderHandler(){
        fetch(process.env.REACT_APP_EC_URL+'/order' ,{
            method : 'POST',
    ...
    return  cartItems.length > 0 ?  <Fragment>
           ...
           {cartItems.length ==  1 ?<Fragment> <h2 className="mt-5">Your Cart : <b>{cartItems.length} Item</b></h2> 
          </Fragment> : <h2 className="mt-5">Your Cart : <b>{cartItems.length} Items</b></h2>}
        ...
        <div className="col-12 col-lg-3 my-4">
            ...
            </Fragment> : ( !complete ? <h2 className="mt-5"> Your Cart is Empty ! </h2> : <Fragment> <h2 className="mt-5"> Order Completed ! </h2>
